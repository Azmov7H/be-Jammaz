...
RENDERERS[DOCUMENT_TYPES.SUPPLIER_TRANSACTION_STATEMENT] = function renderSupplierTransactionStatement(data) {
    const {
        branding = {},
        title = 'حركات مورد',
        supplier = {},
...
<body>
<div class="doc" data-document-type="supplier-transaction-statement">
    <header class="header">
        <div class="brand">
            <h1>${esc(branding.companyName || 'شركتكم')}</h1>
            ${branding.address ? `<div class="meta">${esc(branding.address)}</div>` : ''}
